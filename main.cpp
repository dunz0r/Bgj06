...
class cRainbow
{
	...
	void create()
	{
		...
		ALLEGRO_COLOR color[1] = al_map_rgb(255,127,0);
		ALLEGRO_COLOR color[2] = al_map_rgb(255,255,0);
		ALLEGRO_COLOR color[3] = al_map_rgb(0,255,0);
		ALLEGRO_COLOR color[4] = al_map_rgb(0,0,255);
		ALLEGRO_COLOR color[5] = al_map_rgb(75,0,130);
		ALLEGRO_COLOR color[6] = al_map_rgb(143,0,255);
